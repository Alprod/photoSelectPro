 ...
 */
final class Version20231119025731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE photo (id INT NOT NULL, client_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, filename VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
