 ...
 */
final class Version20240113210202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD selection_process_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_14B78418660D626F');
        $this->addSql('ALTER TABLE photo DROP selection_process_id');
    }
}
